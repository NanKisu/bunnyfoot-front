  ...
  data () {
    return {
      ...
      resultText: [
        ...
        '￮ 일반적인 토끼의 규칙은 내 토끼에게 적용되지 않아요.<br>￮ 가끔 얘가 토끼인지 강아지인지 모르겠어요.<br>￮ 그동안 먹여주고 입혀주고(?) 재워준 건 난데 집사고 뭐고 간식이라도 가진 사람이 있으면 난리남!<br>￮ 조금은 내멋대로인 활달한 성격을 가졌어요<br>￮ 에너지를 발산할 수 있는 환경을 조성해주면 좋을 것 같아요.',
        '￮ 사람을 좋아하는 토끼! 집사 껌딱지!<br>￮ 애교가 많아서 하루하루 나를 행복하게 만들어줘요<br>￮ 이런 토끼와 함께 사는 집사는 로또 맞은 격! 가장 적은 성격 유형이랍니다<br>￮ 애교가 많은 토끼인 만큼 집사도 토끼와 많은 시간을 보낼 수 있도록 노력하는 게 좋을 것 같네요!',
        '￮ 너무 순딩순딩한 인형 같은 토끼!<br>￮ 다른 토끼들은 허락하지 않는 곳까지 만질 수 있게 해줘요<br>￮ 집사와 교감이 잘 되는 유형!<br>￮ 토끼는 주인의 품 속에서 자고싶어할 지도 ?!<br>￮ 하지만 다른 토끼들을 만났을 때에도 순하다는 보장은 없으니 조심하세요!'
      ],
      imgCaptured: null,
      envHost: ''
    }
